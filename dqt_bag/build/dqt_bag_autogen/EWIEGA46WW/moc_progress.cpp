...
QT_MOC_LITERAL(1, 9, 11), // "sliderValue"
QT_MOC_LITERAL(2, 21, 0) // ""

    },
    "Progress\0sliderValue\0"
};
...
void Progress::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sliderValue((*reinterpret_cast< float(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            typedef void (Progress::*_t)(float );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Progress::sliderValue)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject Progress::staticMetaObject = {
    { &QSlider::staticMetaObject, qt_meta_stringdata_Progress.data,
      qt_meta_data_Progress,  qt_static_metacall, nullptr, nullptr}
};
...
// SIGNAL 0
void Progress::sliderValue(float _t1)
{
